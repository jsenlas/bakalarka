...
%   xsenca00-20-literatura-bibliography.bib - literatura / bibliography
%   xsenca00-01-kapitoly-chapters.tex - obsah práce / the thesis content
%   xsenca00-01-kapitoly-chapters-en.tex - obsah práce v angličtině / the thesis content in English
%   xsenca00-30-prilohy-appendices.tex - přílohy / appendices
%   xsenca00-30-prilohy-appendices-en.tex - přílohy v angličtině / appendices in English
%==============================================================================
...
% I have listed all the literary sources, publications and other sources, which were used during the preparation of this thesis.},
  ...
  acknowledgment={Ďakujem môjmu vedúcemu Martinovi Sakinovi.},
...
\begin{document}
  ...
  % ----------------------------------------------
  \ifenglish
    \input{xsenca00-01-kapitoly-chapters-en}
  \else
    \input{xsenca00-01-kapitoly-chapters}
  \fi
...
\fi
  \begin{flushleft}
  \bibliography{xsenca00-20-literatura-bibliography}
  \end{flushleft}
...
\fi
  ...
  % Přílohy / Appendices
  \ifenglish
    \input{xsenca00-30-prilohy-appendices-en}
  \else
    \input{xsenca00-30-prilohy-appendices}
  \fi
  
  % Kompilace po částech (viz výše, nutno odkomentovat)
  % Compilation piecewise (see above, it is necessary to uncomment it)
  %\subfile{xsenca00-30-prilohy-appendices}
